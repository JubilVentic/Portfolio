  ...
  return (
    ...
    >
      <div className="max-w-2xl">
        ...
        <h1 className="mt-2 font-display text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-[3.25rem]">
          {site.title}
        </h1>
        ...
        <Link
          href="/projects"
          className="mt-10 inline-flex w-fit text-sm font-medium text-accent hover:underline"
        >
          View my work →
        </Link>
      </div>
